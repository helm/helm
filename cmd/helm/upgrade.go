...
func newUpgradeCmd(cfg *action.Configuration, out io.Writer) *cobra.Command {
	...
	f.BoolVar(&client.RollbackOnFailure, "rollback-on-failure", false, "if set, Helm will rollback the upgrade on failure. The --wait flag will be set automatically if --rollback-on-failure is used")
