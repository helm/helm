...
func addInstallFlags(f *pflag.FlagSet, client *action.Install, valueOpts *values.Options) {
	...
	f.BoolVar(&client.Replace, "replace", false, "re-use the given name, even if that name is already used by a deleted release with history kept. This is unsafe in production")
