...
func newLintCmd(out io.Writer) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			for _, path := range paths {
				...
				total += result.TotalChartsLinted
			...
			summary := fmt.Sprintf("%d chart(s) linted, %d chart(s) failed", total, failed)
			if failed > 0 {
	...
	f.BoolVar(&client.Recursive, "recursive", false, "lint sub charts")
