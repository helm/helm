...
func (Metadata_Engine) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metadata_c662cce751dc58d2, []int{1, 0}
}
...
func (*Maintainer) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_c662cce751dc58d2, []int{0}
}
...
func (*Metadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_c662cce751dc58d2, []int{1}
}
...
func init() { proto.RegisterFile("hapi/chart/metadata.proto", fileDescriptor_metadata_c662cce751dc58d2) }

var fileDescriptor_metadata_c662cce751dc58d2 = []byte{
