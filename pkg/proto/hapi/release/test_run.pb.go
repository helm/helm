...
func (TestRun_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_run_1513e535f89a0ba0, []int{0, 0}
}
...
func (*TestRun) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_run_1513e535f89a0ba0, []int{0}
}
...
func init() {
	proto.RegisterFile("hapi/release/test_run.proto", fileDescriptor_test_run_1513e535f89a0ba0)
}

var fileDescriptor_test_run_1513e535f89a0ba0 = []byte{
