...
func (Status_Code) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_status_ff7fa4e39d25a865, []int{0, 0}
}
...
func (*Status) Descriptor() ([]byte, []int) {
	return fileDescriptor_status_ff7fa4e39d25a865, []int{0}
}
...
func init() { proto.RegisterFile("hapi/release/status.proto", fileDescriptor_status_ff7fa4e39d25a865) }

var fileDescriptor_status_ff7fa4e39d25a865 = []byte{
