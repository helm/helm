...
func (l *Lint) Run(paths []string, vals map[string]interface{}) *LintResult {
	...
	for _, path := range paths {
		linter, err := lintChart(path, vals, l.Namespace, l.Strict, l.EnableFullPath)
		if err != nil {
...
func lintChart(path string, vals map[string]interface{}, namespace string,
	strict, enableFullPath bool) (support.Linter, error) {
	...
	return lint.All(chartPath, vals, namespace, strict, enableFullPath), nil
}
