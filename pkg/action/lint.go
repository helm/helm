...
func (l *Lint) Run(paths []string, vals map[string]interface{}) *LintResult {
	...
	for _, path := range paths {
		linter, err := lintChart(path, vals, l.Namespace, l.Strict, l.Version)
		if err != nil {
...
func lintChart(path string, vals map[string]interface{}, namespace string, strict bool, version string) (support.Linter, error) {
