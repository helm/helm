...
func (h *HookFailingKubeClient) Delete(resources kube.ResourceList, policy metav1.DeletionPropagation) (*kube.Result, []error) {
	for _, res := range resources {
	...
	return h.PrintingKubeClient.Delete(resources, policy)
}
