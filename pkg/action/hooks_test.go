...
func (h *HookFailingKubeClient) GetWaiter(strategy kube.WaitStrategy, opts ...kube.WaitOption) (kube.Waiter, error) {
	waiter, _ := h.PrintingKubeClient.GetWaiter(strategy, opts...)
