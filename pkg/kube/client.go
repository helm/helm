...
func (c *Client) Update(original, target ResourceList, force bool, threeWayMergeForUnstructured bool) (*Result, error) {
	updateErrors := []string{}
	res := &Result{}
	...
	err := target.Visit(func(info *resource.Info, err error) error {
		...
		if err := updateResource(c, info, originalInfo.Object, force, threeWayMergeForUnstructured); err != nil {
