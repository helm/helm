...
func TestFindChartInRepoURL(t *testing.T) {
	...
	chartURL, err := FindChartInRepoURL(srv.URL, "nginx", "", "", "", "", getter.All(environment.Settings{}))
	if err != nil {
		t.Errorf("%s", err)
	}
	...
	chartURL, err = FindChartInRepoURL(srv.URL, "nginx", "0.1.0", "", "", "", getter.All(environment.Settings{}))
	if err != nil {
		t.Errorf("%s", err)
	}
...
func TestErrorFindChartInRepoURL(t *testing.T) {
	_, err := FindChartInRepoURL("http://someserver/something", "nginx", "", "", "", "", getter.All(environment.Settings{}))
	if err == nil {
	...
	_, err = FindChartInRepoURL(srv.URL, "nginx1", "", "", "", "", getter.All(environment.Settings{}))
	if err == nil {
	...
	_, err = FindChartInRepoURL(srv.URL, "nginx1", "0.1.0", "", "", "", getter.All(environment.Settings{}))
	if err == nil {
		t.Errorf("Expected error for chart not found, but did not get any errors")
	}
	...
	_, err = FindChartInRepoURL(srv.URL, "chartWithNoURL", "", "", "", "", getter.All(environment.Settings{}))
	if err == nil {
