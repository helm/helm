...
func newPluginUninstallCmd(logger *slog.Logger, out io.Writer) *cobra.Command {
...
func (o *pluginUninstallOptions) run(out io.Writer) error {
	...
	for _, name := range o.names {
		if found := findPlugin(plugins, name); found != nil {
			if err := uninstallPlugin(o.logger, found); err != nil {
...
func uninstallPlugin(logger *slog.Logger, p plugin.Plugin) error {
