...
func newPluginUpdateCmd(logger *slog.Logger, out io.Writer) *cobra.Command {
...
func (o *pluginUpdateOptions) run(out io.Writer) error {
	...
	for _, name := range o.names {
		if found := findPlugin(plugins, name); found != nil {
			if err := updatePlugin(o.logger, found); err != nil {
...
func updatePlugin(logger *slog.Logger, p plugin.Plugin) error {
