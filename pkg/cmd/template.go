...
func newTemplateCmd(cfg *action.Configuration, out io.Writer) *cobra.Command {
	...
	f.String(
		"dry-run",
		"server",
		`simulate the operation. must be either "client" or "server" (default). If '--dry-run=client', operations will be performed client-side only, and cluster connections avoid. '--dry-run=server' will enable server connectivity`)
