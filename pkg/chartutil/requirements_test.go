...
func TestProcessRequirementsImportValues(t *testing.T) {
	...
	// Check to see if we can get all the values.
	e["imported-chart1-all.service.name"] = "nginx"
	e["imported-chart1-all.service.type"] = "ClusterIP"
	e["imported-chart1-all.service.externalPort"] = "80"
	e["imported-chart1-all.service.internalPort"] = "80"
	e["imported-chart1-all.SC1data.SC1bool"] = "true"
	e["imported-chart1-all.SC1data.SC1float"] = "3.14"
	e["imported-chart1-all.SC1data.SC1int"] = "100"
	e["imported-chart1-all.SC1data.SC1string"] = "dollywood"
	e["imported-chart1-all.SC1data.SC1extra1"] = "11"
	e["imported-chart1-all.imported-chartA.SC1extra2"] = "1.337"
	e["imported-chart1-all.overridden-chartA.SCAbool"] = "true"
	e["imported-chart1-all.overridden-chartA.SCAfloat"] = "3.14"
	e["imported-chart1-all.overridden-chartA.SCAint"] = "100"
	e["imported-chart1-all.overridden-chartA.SCAstring"] = "jabathehut"
	e["imported-chart1-all.overridden-chartA.SC1extra3"] = "true"
	e["imported-chart1-all.imported-chartA-B.SC1extra5"] = "tiller"
	e["imported-chart1-all.overridden-chartA-B.SCAbool"] = "true"
	e["imported-chart1-all.overridden-chartA-B.SCAfloat"] = "3.33"
	e["imported-chart1-all.overridden-chartA-B.SCAint"] = "555"
	e["imported-chart1-all.overridden-chartA-B.SCAstring"] = "wormwood"
	e["imported-chart1-all.overridden-chartA-B.SCAextra1"] = "23"
	e["imported-chart1-all.overridden-chartA-B.SCBbool"] = "true"
	e["imported-chart1-all.overridden-chartA-B.SCBfloat"] = "0.25"
	e["imported-chart1-all.overridden-chartA-B.SCBint"] = "98"
	e["imported-chart1-all.overridden-chartA-B.SCBstring"] = "murkwood"
	e["imported-chart1-all.overridden-chartA-B.SCBextra1"] = "13"
	e["imported-chart1-all.overridden-chartA-B.SC1extra6"] = "77"
	e["imported-chart1-all.SCBexported1A.SC1extra7"] = "true"
