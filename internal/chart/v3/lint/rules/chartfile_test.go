...
const (
	...
	badChartNameDNSDir      = "testdata/badchartnamedns"
...
var (
	...
	badChartNameDNSPath      = filepath.Join(badChartNameDNSDir, "Chart.yaml")
...
var badChartNameDNS, _ = chartutil.LoadChartfile(badChartNameDNSPath)
...
func TestValidateChartName(t *testing.T) {
	...
	err = validateChartName(badChartNameDNS)
	if err == nil {
		t.Error("expected validateChartName to return a linter error for a DNS-invalid name, got no error")
	}
}
