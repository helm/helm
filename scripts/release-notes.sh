...
- [Linux mips64le](https://get.helm.sh/helm-${RELEASE}-linux-mips64le.tar.gz) ([checksum](https://get.helm.sh/helm-${RELEASE}-linux-mips64le.tar.gz.sha256sum) / $(cat _dist/helm-${RELEASE}-linux-mips64le.tar.gz.sha256))
